...
export function buildPromotionalEmail(input: PromotionalEmailInput): string {
    ...
    <p style="font-size:12px;color:#9CA3AF;margin:0;">
      You're receiving this because you opted in to marketing emails from ${clientEnv.PUBLIC_APP_NAME}.
      <a href="${clientEnv.PUBLIC_APP_URL}/account/notifications" style="color:#9CA3AF;">Unsubscribe</a>
    </p>
  `;
