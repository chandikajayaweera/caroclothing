/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 5bdeb391f37eda7c7548f8a5ab58bfad)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_APP_NAME" | "PUBLIC_APP_URL" | "EMAIL_FROM_ADDRESS" | "TEXT_LK_SENDER_ID" | "PUBLIC_OTP_COOLDOWN_SECONDS" | "DATABASE_URL" | "DATABASE_AUTH_TOKEN" | "BETTER_AUTH_SECRET" | "PUBLIC_GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY" | "TEXT_LK_API_KEY">> {}
}
