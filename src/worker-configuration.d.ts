/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 01ae1f4dce3a62afab22b98f06615272)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "DATABASE_AUTH_TOKEN" | "ORIGIN" | "BETTER_AUTH_SECRET">> {}
}
